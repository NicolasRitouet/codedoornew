...
<body>
    <div class="main">
        <div class="wrapper">
            ...
            <?php  
            // Heading
                $image="<img src=img/solar-system.png>";
                $heading1 = "Be part of the most meaningful";
                $heading2 = "developer network in the universe.";
                // Subheading 
                $sub_header1 = 'Be part of something incredibly rewarding.';
                $sub_header2 = '';   
                // Status variable indicate to if the page need a contact us button or a form !
                $status = 'contact';
                // Status button text , if not the value Null ! 
                $status_text = 'Join us, become a tutor';
            ?>
            <?php include('home/header.php'); ?>
            <?php include('home/benefits.html');?>
            <?php include('home/ref.html');?>
            <!--Courses  -->
            <?php include('home/coursestutors.html');?>
            <!-- Subscribe  -->
