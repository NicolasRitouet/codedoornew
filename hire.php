...
<body>
    <div class="main">
        <div class="wrapper">
            <?php  $image="<img src=img/one.png>";$heading1="Hire excellent coders." ; $heading2="" ; $sub_header1='Contact us to find your next top notch developer.' ; $sub_header2='Engineers Background: Front-End, Full Stack, Android, iOS, Machine Learning, Cyber Security.' ; $status='contact' ; $status_text="Contact us"?>
            <?php include( 'home/header.php') ?>
            <?php include( 'home/coders.html') ?>
