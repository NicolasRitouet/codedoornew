...
<body>
    <div class="main">
        <div class="wrapper">
            ...
            <?php  
            // Heading
                $image="<img src=img/graduation.png>";
                $heading1 = "Receive a scholarhip";
                $heading2 = "to learn how to code and to get a job.";
                // Subheading 
                $sub_header1 = 'Get a scholarship out of this world supported by Udacity, GitHub, AWS, Cisco, Google, Salesforce and JetBrains';
                $sub_header2 = '';   
                // Status variable indicate to if the page need a contact us button or a form !
                $status = 'contact';
                // Status button text , if not the value Null ! 
                $status_text = 'Get started now ';
            ?>
            <?php include('home/header.php');?>
            <?php include('home/howitworks.html');?>
            <?php include('home/thekey.html');?>
            <!--Courses  -->
            <?php include('home/courses.html');?>
            <?php include('home/howscholarshipworks.html');?>
            <!--Students   -->
            <?php include('home/ref.html');?>
            <!--Subscription  -->
            <?php include('home/subscripe.php');?>            
            <!-- Footer  -->
